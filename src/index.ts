...
import { publicRoutes, api, adminUi, debug, cdp, hooks } from './routes';
...
// Mount webhook routes (uses WHATSAPP_HOOK_TOKEN, not CF Access)
// Must be before CF Access middleware so WaSender can call without auth headers
